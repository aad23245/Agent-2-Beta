#!/usr/bin/env python3
"""
agent2web.py â€” Agent2 entry point
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
Wires together the agent2 package and starts the Flask-SocketIO server.

Project layout
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  agent2web.py         â† you are here  (python run.py  or  python agent2web.py)
  agent2cli.py         â† agent2 CLI entry point (python agent2cli.py)
  run.py               â† cross-platform setup launcher (creates venv, installs deps)
  .env                 â† API keys  (auto-created by run.py or Settings UI)
  agent2.db            â† SQLite database (auto-created on first run)
  agent2/
    __init__.py
    config.py          â† platform detection, models, modes, constants, root paths
    database.py        â† SQLite helpers (qall / qone / exe) + schema + migrations
    keys.py            â† KeyRotator: multi-key, rotation, pinning, usage tracking
    terminal.py        â† stream_command, stdin injection, kill, stop events
    agent.py           â† system_prompt, build_context, run_agent agentic loop
    routes.py          â† all /api/* REST endpoints
    sockets.py         â† all Socket.IO event handlers
    ui.py              â† full HTML / CSS / JS single-page frontend
"""
...
# ðŸ”’ VENV ENFORCEMENT (MUST RUN FIRST)
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# ðŸ”¥ Enforce venv BEFORE any imports that rely on dependencies
ensure_venv()


# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# ðŸ“¦ Imports (safe after venv enforcement)
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
