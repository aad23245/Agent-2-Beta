...
_ISSUE_WELCOME: str = (
    "ðŸ‘‹ **Welcome, @{author}!** Thank you for opening this issue.\n\n"
    ...
    "We appreciate your contribution to **Agent-2**! ðŸš€"
)

_PR_WELCOME: str = (
    "ðŸ‘‹ **Welcome, @{author}!** Thank you for this pull request.\n\n"
...
def run(github_api: "GitHubAPI", gemini_client: "GeminiClient") -> None:
    ...
    Args:
        ...
        gemini_client: Gemini AI client (unused â€” kept for interface parity).
    """
